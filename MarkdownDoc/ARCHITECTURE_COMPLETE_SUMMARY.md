...
│
└── DbExplorer.exe                             # Renamed from WindowsDb2Editor.exe
```
...
| **Week 2** | Namespace | Find/Replace: `namespace WindowsDb2Editor` → `namespace DbExplorer`<br>Update .csproj: WindowsDb2Editor.csproj → DbExplorer.csproj |
| **Week 3** | References | Find/Replace: `using WindowsDb2Editor.` → `using DbExplorer.`<br>Update XAML: `xmlns:local="clr-namespace:WindowsDb2Editor"` → `xmlns:local="clr-namespace:DbExplorer"` |
