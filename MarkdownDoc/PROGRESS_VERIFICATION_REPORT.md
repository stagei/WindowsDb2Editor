...
- **Documentation**: `MarkdownDoc/SEMANTIC_QUERY_NAMING.md`
...
### Documentation
- `MarkdownDoc/SEMANTIC_QUERY_NAMING.md` - Naming guide
- `MarkdownDoc/SQL_EXTRACTION_VERIFICATION.md` - Extraction status
- `MarkdownDoc/PROGRESS_VERIFICATION_REPORT.md` - This report
