...
| `App.xaml.cs` | Log message "WindowsDb2Editor" → New app name |
...
| Folder name `WindowsDb2Editor` in AppData | → New app name |
...
| `Program.cs` | `WindowsDb2EditorTester` → `DbExplorerTester` |
