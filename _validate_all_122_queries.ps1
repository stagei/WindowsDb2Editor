...
& $exe --profile $Profile --command table-props --object "$TestSchema.$TestTable" --outfile "validation_cli_tableprops.json" 2>&1 | Out-Null

# Get Form data
& $exe --profile $Profile --test-form table-details --object "$TestSchema.$TestTable" --tab columns --outfile "validation_form_columns.json" 2>&1 | Out-Null

if ((Test-Path "validation_cli_tableprops.json") -and (Test-Path "validation_form_columns.json")) {
    $cliData = (Get-Content "validation_cli_tableprops.json" -Raw | ConvertFrom-Json).columns
    $formData = (Get-Content "validation_form_columns.json" -Raw | ConvertFrom-Json).data.rows
...
& $exe --profile $Profile --test-form table-details --object "$TestSchema.$TestTable" --tab foreign-keys --outfile "validation_form_fks.json" 2>&1 | Out-Null

if ((Test-Path "validation_form_fks.json")) {
...
& $exe --profile $Profile --test-form table-details --object "$TestSchema.$TestTable" --tab indexes --outfile "validation_form_indexes.json" 2>&1 | Out-Null

if ((Test-Path "validation_form_indexes.json")) {
...
& $exe --profile $Profile --test-form table-details --object "$TestSchema.$TestTable" --tab ddl-script --outfile "validation_form_ddl.json" 2>&1 | Out-Null

if ((Test-Path "validation_form_ddl.json")) {
...
& $exe --profile $Profile --test-form table-details --object "$TestSchema.$TestTable" --tab incoming-fk --outfile "validation_form_incoming_fk.json" 2>&1 | Out-Null

if ((Test-Path "validation_form_incoming_fk.json")) {
